    ...
    $(".btn-tree").click(function(){
       if($(this).html() == "待审核"){
         ...
         <div id="shenheyemian" style="display: none;">
                    ...
                    <div style="font-size: large;position: relative;left:20%;display: inline-block;">职位</div><input type="text" disabled style="position: relative;left:22%;font-size:large;box-shadow: 10px 10px 0px -8px #9a9a9a inset;background-color: #f1f1f1;" value="科员">
                    <br><br>
                    <div style="font-size: large;position: relative;left:10%;display: inline-block;">电话</div><input type="text" disabled style="position: relative;left:12%;font-size:large;box-shadow: 10px 10px 0px -8px #9a9a9a inset;background-color: #f1f1f1;" value="166622589999">
                    <div style="font-size: large;position: relative;left:15%;display: inline-block;">申请时间</div><input type="text" disabled style="position: relative;left:17%;font-size:large;box-shadow: 10px 10px 0px -8px #9a9a9a inset;background-color: #f1f1f1;" value="2020-03-20">
                    <div style="font-size: large;position: relative;left:20%;display: inline-block;">申请状态</div><input type="text" disabled style="position: relative;left:22%;font-size:large;box-shadow: 10px 10px 0px -8px #9a9a9a inset;background-color: #f1f1f1;" value="已申请">
                    <br><br>
                    <div style="font-size: large;position: relative;left:10%;display: inline-block;">申请用途</div><textarea name="" id="" cols="30" rows="10" style="background-color: #ededed;width: 60%;height:150px;position: relative;left:12%;vertical-align: top;border: 1px solid #000;font-size: large;" disabled>环境信息分析上报省里进行汇报</textarea>
                    <br><br>
